...
class CreateWalletsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['channels'], function (Blueprint $table) use($tableNames) {
            $table->id();
            $table->string('title')->unique();
            $table->string('abbr')->nullable();
            $table->enum('type', $tableNames['channels']::CHANNEL_TYPES_KEY);
        ...
        Schema::create($tableNames['financial_details'], function (Blueprint $table) use($tableNames, $columnNames) {
            $table->id();
